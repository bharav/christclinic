...
import IPatientCommitteeDataProvider from "./IPatientCommitteeDataProvider";

class PatientCommitteeDataProvider implements IPatientCommitteeDataProvider {
...
export default PatientCommitteeDataProvider;
